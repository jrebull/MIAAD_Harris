...
Tras las 30 corridas independientes, se combinaron todos los archivos finales y se filtraron las soluciones dominadas. El \textbf{frente de Pareto combinado} contiene \textbf{54 soluciones no dominadas}, que representan la mejor aproximación obtenida al frente de Pareto real del problema.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{pareto_front.png}
    \caption{Frente de Pareto combinado (54 soluciones no dominadas) de las 30 corridas independientes de MOHHO. El eje horizontal corresponde a $f_1$ (carga de espera no atendida) y el eje vertical a $f_2$ (máxima disparidad entre países). Se incluye el punto del sistema FIFO como referencia.}
    \label{fig:pareto}
\end{figure}
...
\rowcolor{gray!8}
Mejor en $f_2$ (máxima equidad) & 8,3006 & 2,8815 \\
...
Media & 10,9919 \\
\rowcolor{gray!8}
Desviación estándar & 0,2342 \\
Mínimo & 10,5823 \\
\rowcolor{gray!8}
Máximo & 11,4320 \\
Coeficiente de variación & 2,13\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{Diagrama de caja del hipervolumen (HV) de las 30 corridas. La mediana (línea central) y la media (rombo) son cercanas, indicando distribución simétrica. El coeficiente de variación de 2{,}13\% confirma la estabilidad del algoritmo.}
    \label{fig:hv_box}
\end{figure}

El coeficiente de variación del 2{,}13\% ($\sigma / \mu = 0{,}2342 / 10{,}9919$) indica que MOHHO produce resultados consistentes entre corridas. La diferencia entre el HV mínimo (10{,}5823) y máximo (11{,}4320) es de menos de una unidad, lo que confirma la robustez del método.
...
Mejor $f_2$ (MOHHO) & 8,3006 & 2,8815 & Equidad radical \\
\rowcolor{gray!8}
...
El frente de Pareto ofrece 54 asignaciones no dominadas que representan un abanico de opciones para el tomador de decisiones. Se destacan tres escenarios tipo:
...
$f_1 = 8{,}3006$, $f_2 = 2{,}8815$ años.\\
Se distribuyen las visas de forma que todos los países tengan tiempos de espera similares. La disparidad máxima se reduce de 13{,}00 a 2{,}88 años, pero la carga de espera global aumenta ligeramente (de 8{,}09 a 8{,}30). Este escenario es coherente con las propuestas de reforma de topes por país \parencite{fwd2024}.
\end{examplebox}
...
\begin{itemize}
    ...
    \item \textbf{Magnitud del trade-off:} Pasar de la mejor solución en $f_1$ ($8{,}0459$) a la mejor en $f_2$ ($8{,}3006$) implica un incremento de solo 0{,}2547 en $f_1$ (3{,}16\%), pero una reducción de $f_2$ de 12{,}00 a 2{,}88 años (76\%). La relación es \textbf{fuertemente asimétrica}: se gana mucha equidad con poca pérdida de eficiencia.
\end{itemize}
...
La estabilidad del hipervolumen ($\text{HV} = 10{,}9919 \pm 0{,}2342$, coeficiente de variación 2{,}13\%) indica que MOHHO produce resultados consistentes. La convergencia antes de la iteración 300 sugiere que los parámetros seleccionados son adecuados para este problema. La consistencia entre corridas permite confiar en que el frente combinado de 54 soluciones es una buena aproximación al frente de Pareto verdadero.
...
\begin{enumerate}
    ...
    \item \textbf{Herramienta de apoyo a la decisión:} El frente de Pareto con 54 soluciones no dominadas proporciona un abanico cuantificado de opciones que permite al tomador de decisiones visualizar explícitamente las consecuencias de priorizar eficiencia vs.\ equidad.
...
\begin{enumerate}
    \item \textbf{El modelo biobjetivo captura un conflicto real.} Las 54 soluciones no dominadas del frente de Pareto combinado confirman que existe un trade-off genuino entre minimizar la carga de espera ($f_1$) y minimizar la disparidad entre países ($f_2$). La prueba de conflicto con permutaciones concretas (G2) y los resultados experimentales son consistentes.
    ...
    \item \textbf{El trade-off es asimétrico a favor de la equidad.} Es posible reducir la disparidad de 13{,}00 a 2{,}88 años con un incremento de solo 2{,}66\% en la carga de espera ($f_1$: de 8{,}0459 a 8{,}3006). Esto sugiere que pequeñas concesiones en eficiencia pueden generar mejoras sustanciales en equidad.

    \item \textbf{El algoritmo es robusto y reproducible.} Las 30 corridas independientes produjeron un hipervolumen medio de $\text{HV} = 10{,}9919 \pm 0{,}2342$ (CV = 2{,}13\%), con convergencia antes de la iteración 300 de las 500 totales.
    ...
    \item \textbf{El frente de Pareto es una herramienta de apoyo a la decisión.} Las 54 soluciones no dominadas ofrecen al tomador de decisiones un abanico cuantificado de escenarios, desde la priorización de eficiencia ($f_1 = 8{,}05$, $f_2 = 12{,}00$) hasta la equidad radical ($f_1 = 8{,}30$, $f_2 = 2{,}88$), permitiendo una elección informada basada en preferencias de política pública.
\end{enumerate}
